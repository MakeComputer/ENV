...
#
# Generated by Vivado on Fri Dec 01 16:05:03 +0700 2017
...
# Script info
echo -e "fontRom.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fontRom xil_defaultlib.fontRom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim fontRom -key {Behavioral:sim_1:Functional:fontRom} -tclbatch cmd.tcl -log simulate.log
}
